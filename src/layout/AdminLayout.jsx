...
const Navs = () => {
  return (
    <div className="w-[200px] h-[calc(100svh-70px)] md:h-[100svh] fixed md:sticky top-[70px] md:top-0 bg-white shadow z-10 ">
      <div className="p-5">
      ...
      <nav className="p-5 flex flex-col gap-3">
        ...
        <NavLink
          ...
          className="flex items-center justify-start gap-2 text-xl text-blue-900"
        >
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-full">
        <header className="p-3 bg-white shadow h-[70px] w-[100%] sticky top-0 z-0 flex items-center text-right justify-between">
